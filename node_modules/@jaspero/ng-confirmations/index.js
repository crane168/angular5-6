import { ChangeDetectionStrategy, Component, ComponentFactoryResolver, HostBinding, Injectable, Injector, Input, NgModule, NgZone, TemplateRef, ViewChild, ViewContainerRef, ViewEncapsulation } from '@angular/core';
...
var ConfirmationComponent = /** @class */ (function () {
    ...
    ConfirmationComponent.propDecorators = {
        "true": [{ type: HostBinding, args: ['class.jaspero__confirmation',] },],
        "focusEl": [{ type: ViewChild, args: ['focus',] },],
    };
...
export { JasperoConfirmationsModule, ConfirmationsComponent, ConfirmationComponent, VariableContentComponent, ConfirmationService };
