import { Component, ElementRef, EventEmitter, Injectable, Input, NgModule, Output, Renderer } from '@angular/core';
...
class Timer {
    ...
    process() {
        ...
        let /** @type {?} */ diff = +new Date() - this.nextTime;
        const /** @type {?} */ count = 1 + Math.floor(diff / 100);
        diff = 100 - diff % 100;
        this.nextTime += 100 * count;
        let /** @type {?} */ frequency, /** @type {?} */ step, /** @type {?} */ i, /** @type {?} */ len;
    ...
    remove(fn) {
        this.commands.push(() => {
            const /** @type {?} */ i = this.fns.indexOf(fn);
            if (i !== -1) {
                this.fns.splice(i, 2);
            }
            this.ing = this.fns.length > 0;
...
class CountdownComponent {
    ...
    init() {
        const /** @type {?} */ me = this;
        const /** @type {?} */ el = me.el.nativeElement;
        me.paused = me.config.demand;
        me.stoped = false;
        // 分析markup
        const /** @type {?} */ tmpl = el.innerHTML || me.config.template;
        ...
        const /** @type {?} */ clock = me.config.clock;
        me.hands.forEach((hand) => {
            const /** @type {?} */ type = hand.type;
            let /** @type {?} */ base = 100, /** @type {?} */
            i;
     ...
     */
    getLeft() {
        let /** @type {?} */ left = this.config.leftTime * 1000;
        const /** @type {?} */ end = this.config.stopTime;
        if (!left && end)
...
export { CountdownComponent, CountdownModule, Timer as ɵa };
